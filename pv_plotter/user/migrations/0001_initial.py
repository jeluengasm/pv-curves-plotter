    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('I', 'Intersexual'), ('N', 'No response')], max_length=11, verbose_name='sex')),
                ...
                ('legal_id_type', models.CharField(choices=[('TI', 'TI'), ('CC', 'CC'), ('NIT', 'NIT'), ('Pass', 'Passport')], default='CC', max_length=10, verbose_name='ID type')),
                ('legal_id', models.CharField(max_length=10, verbose_name='legal ID')),
